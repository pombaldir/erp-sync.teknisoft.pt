...
if(isset($_POST['auth_userid'])) $tokenAPI=$_POST['auth_userid']; 
 ...
 switch ($tokenAPI) {  
    case "P9r83K62iX6qC4e":	 
        $bdServer="192.168.1.241,1433";
		$bdUser="sa";
		$bdPswd="megatek";
		$bdName="Emp_TCO";
		$Medlog=true;	
        $EncstrAbrevTpDoc="ENCON";
		$orderDefSeller="1";
		$custmDefSeller="1"; 
		$subzona="PT";
		$strCodCondPag="1";
...
try {
    ...
    $mail->Password = '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';  // SMTP password
