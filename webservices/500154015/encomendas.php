...
$quantidTotal=0;
	...
	$database->insert("Mov_Venda_Lin", [
       ...
       // "fltQuantidadePend" => $vartigo['quantity'],	|| MODULO ENCOMENDAS	
		//"dtmDataEntrega" => "".$dtmDataCarga."",		|| MODULO ENCOMENDAS	
		//"strHoraEntrega" => "".$strHoraCarga."",		|| MODULO ENCOMENDAS	
	...
	$database->insert("Mov_Venda_Lin", [
		...
		"fltQuantidade" => 1,
		//"fltQuantidadePend" => 1, 			|| MODULO ENCOMENDAS	
		...
		$erroPortes=$database->error();
		$errormsg=$erroPortes[2];
