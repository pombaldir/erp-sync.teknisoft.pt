...
$isReferencia=0;    
	...
	$detalhes=array("strCodigo"=>$strCodigo,"strCodCategoria"=>$strCodCategoria,"strCodBarras"=>$strCodBarras,"strDescricao"=>$strDescricao,"strDescricaoCompl"=>$strDescricaoCompl,"strObs"=>$strObs,"strCodFamilia"=>$strCodFamilia,"hasImage"=>$hasImage,"imgData"=>$imgData,"stock"=>$stock,"precos"=>$precos,"familias"=>$arrfam,"referencias"=>$rowRefer); 
