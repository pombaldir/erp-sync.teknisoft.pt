...
define("URLBASE", "https://erpsinc.pt/backoffice"); 
define("DOCROOT", "/home/teknisoftcp/erp-sync.teknisoft.pt/backoffice"); 
define("tokenAPI", "ALt9YV98yv347Zz"); 
 

define("HOST", "localhost"); 			// The host you want to connect to. 
define("USER", "teknisof_erpsync"); 				// The database username. 
define("PASSWORD", "}9kc=&7jYerG"); 			// The database password. 
define("DATABASE", "teknisof_erpsync17");  // The database name.
