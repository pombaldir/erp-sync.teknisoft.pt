...
define("DOCROOT", "/home/erpsinc/public_html/backoffice"); 
define("tokenAPI", "ALt9YV98yv347Zz"); 
 

define("HOST", "localhost"); 			// The host you want to connect to. 
define("USER", "erpsinc_erpsyncb21"); 				// The database username. 
define("PASSWORD", "kh)%+rVzMGrj"); 			// The database password. 
define("DATABASE", "erpsinc_e_master21");  // The database name.
