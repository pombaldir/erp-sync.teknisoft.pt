<?php $ptitle="Artigos";	include("header.php");  
...
<table id="table<?php echo $p;?>" class="table table-striped table-condensed table-bordered display">
  <thead>
    <tr>
      ...
      <th width="4%"><i class="fa fa-exchange"></i></th>
...
$urlws=$webserviceERP."/artigos.php?act_g=view&num=$num&auth_userid=".$webserviceTKN;
      ...
      <div id="myTabContent" class="tab-content">
        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="tab-1">
          ...
          <div class="form-group">
            ...
            <label class="control-label col-md-1 col-sm-1 col-xs-12">Peso Líquido</label>
            <div class="col-sm-1 col-xs-12">
              <input value="<?php echo $obj['fltPesoLiquido'];?>" name="fltPesoLiquido" id="fltPesoLiquido" type="text" class="form-control" placeholder="">
            </div>
              ...
              <div class="thumbnail">
                <div class="image view view-first"> <img class="fotoPrincipal" id="imgpredef" style="height: 100%; display: block; " src="<?php if($obj['imgImagem']!="") { echo 'data:image/jpg;base64,' . $obj['imgImagem'] . ''; } else { echo URLBASE."/attachments/".$_SESSION['empresaID']."/$imagemdef"; } ?>" alt="imagem predefinida" />
                  <div class="mask">
                    ...
                    <div class="tools tools-bottom"> <a href="#"><i class="fa fa-link"></i></a> <a href="#" class="elimFoto" id="foto<?php echo $_SESSION['empresaID']; ?>"  data-tipo="mainfoto"><i class="fa fa-times"></i></a> </div>
                  </div>
                </div>
                <div class="caption">
                  <p><?php echo $obj['strCodigo'];?> <a href="#" role="button" class="fileinput-button"> <i class="fa fa-pencil"></i> editar
                    <input id="fileupload" type="file" name="files[]" data-form-data='{"num": "<?php echo $num;?>","tipo": "mainfoto"}'>
                    </a> </p>
                </div>
              </div>
            </div>
        ...
        <div role="tabpanel" class="tab-pane fade" id="tab_price" aria-labelledby="tab-price">
          <div class="form-group">
            ...
            <!--      
 <label class="control-label col-md-2 col-sm-2 col-xs-12">Cód. Barras:</label>
            <div class="col-sm-3 col-xs-12">
              <input value="<?php echo $obj['strCodBarras'];?>" name="strCodBarras" id="strCodBarras" type="text" class="form-control" placeholder="">
            </div>   --> 
...
foreach($obj1 as $k=>$valorFamilia){	
	...
	echo">".$valF['strDescricao']." [".$valF['strCodigo']."]</option>";
	}
